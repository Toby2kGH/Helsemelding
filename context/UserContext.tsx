...
function lagInitialSamtykkeState(profil: UserProfile): SamtykkeState {
  ...
  return {
    ...
    epikrise_til_fastlege: profil.samtykker.epikrise_til_fastlege,
    fastlege_sykehusjournal_innsyn: profil.samtykker.fastlege_sykehusjournal_innsyn,
    fastlege_digital_kommunikasjon: profil.samtykker.fastlege_digital_kommunikasjon,
    fastlege_spesialist_deling: profil.samtykker.fastlege_spesialist_deling,
    kjernejournal_oppslag: null,
    ...
    fullmakt_paroerende: null,
    forskning_journaldata: null,
    kommune_samordning_omsorg: profil.samtykker.kommune_samordning_omsorg,
    kommune_helsekoordiator_innsyn: profil.samtykker.kommune_helsekoordiator_innsyn,
    digital_samhandling_helsenorge: profil.samtykker.digital_samhandling_helsenorge,
    paroerende_informasjon: null,
    paroerende_navn: "",
    kvalitetsregistre: kvReg,
    kvalitetsforbedring: null,
    forebyggende_helse_kontakt: null,
