...
import { FlowHeader } from "@/components/flow/FlowChrome";

export function FlowOppsummering({
  steg,
  basePath,
  versjon,
}: {
  ...
  const { viktigForMeg, viktigFritekst, valgteHandlinger, fullfort, fullforSteg } =
    useHelsemelding11();
  const nav = flowNav(steg, "oppsummering", basePath, fullfort);
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        {sendt ? (
          <div className="rounded-lg border border-success-700 bg-success-100 p-6 text-center">
            ...
            <h1 className="text-2xl font-bold text-neutral-900 mt-3">Helsemelding {versjon} sendt</h1>
            ...
            <p className="text-xs text-neutral-500 mt-4">Dette er en demo — ingenting er faktisk sendt.</p>
            <Link
              href="/min-helse"
          ...
          <>
            <FlowHeader nr={nav.nr} total={nav.total} title="Oppsummering">
              Se hva som sendes — strukturert, ikke fritekst — og til hvem. Alt forankres i det du
              sa var viktig for deg.
            </FlowHeader>
            ...
            <section className="mb-6 rounded-lg border-2 border-blueberry-500 bg-blueberry-50 p-4">
              ...
              {viktigTekst ? (
                ...
                <p className="text-neutral-400 italic">
                  Ikke angitt.{" "}
                  <Link href={`${basePath}/viktig`} className="text-blueberry-700 hover:underline not-italic">
                    Legg til
                  </Link>
                </p>
              )}
            ...
            <section className="mb-6 rounded-lg border border-neutral-200 bg-white p-4">
              ...
              <dl className="grid grid-cols-2 gap-3 text-sm sm:grid-cols-3">
                <div>
                  ...
                  <dd className="font-medium text-neutral-900">{antallGjennomgatt} av {antallLegemidler} gjennomgått</dd>
                </div>
                <div>
                  <dt className="text-neutral-500 text-xs">Avvik</dt>
                  <dd className="font-medium text-neutral-900">
                    {antallAvvik > 0 ? <span className="text-warning-700">{antallAvvik} registrert</span> : "Ingen"}
                  </dd>
                </div>
                <div>
            ...
            <p className="text-xs font-semibold uppercase tracking-wide text-neutral-500 mb-2">Dette sendes videre</p>
