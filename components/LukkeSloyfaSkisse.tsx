...
type Kanal = "fastlege" | "e-konsultasjon" | "kommune";
...
const kanalStil: Record<Kanal, { navn: string; klasse: string }> = {
...
/** Utleder konkrete oppfølgingsforslag fra det Helsemeldingen allerede vet. */
function utledHandlinger(profil: UserProfile): Handling[] {
