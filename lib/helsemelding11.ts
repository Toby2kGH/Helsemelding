...
export const STEG_11: { id: number; key: Steg11; label: string; path: string }[] = [
  ...
  { id: 4, key: "forebygging", label: "Forebygging", path: "/helsemelding-1-1/forebygging" },
  { id: 5, key: "oppfolging", label: "Oppfølging", path: "/helsemelding-1-1/oppfolging" },
  { id: 6, key: "oppsummering", label: "Oppsummering", path: "/helsemelding-1-1/oppsummering" },
];
